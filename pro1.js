...
nav.style.cssText=" display: flex; justifey-content:center;align-items: center; gap:30px;"
...
for(let i=1 ; i <=16 ;i++) {
    ...
    let pargrafText=document.createTextNode("project");  
    heding=i;
    pargraf.append(pargrafText);
     sechen.append(pargraf) ;
     sechen.prepend(heding) ;
    content.append(sechen);
     sechen.style.cssText=" border:solid 1px rgb(0, 190, 248);padding:20px;text-align:center; width:250px; ";
};
